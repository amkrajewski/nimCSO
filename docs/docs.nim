...
## 
## 
## .. figure:: https://img.shields.io/badge/GitHub-Repository-Badge?logo=github&color=black
##   :alt: GitHub
...
## ## Quick Start
## 
## **To use ``nimCSO`` you don't even need to install anything, as long as you have a (free) GitHub account, since we prepared a pre-configured Codespace for you!** Simply click on the 
## link below and it will create a cloud development environment for you, with all dependencies installed for you through [Conda](https://docs.conda.io/en/latest/) and 
## [Nimble](https://github.com/nim-lang/nimble) package managers. You can then run ``nimCSO`` through terminal or play with a Jupyter notebook we prepared.
## 
## .. figure:: https://github.com/codespaces/badge.svg
##   :alt: Main nimCSO figure
##   :target: https://codespaces.new/amkrajewski/nimCSO?quickstart=1
## 
##
## ## General 
## 
